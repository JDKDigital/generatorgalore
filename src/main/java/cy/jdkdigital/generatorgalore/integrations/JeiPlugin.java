...
//            Item item = ForgeRegistries.ITEMS.getValue(new ResourceLocation(GeneratorGalore.MODID, itemName));
//            registration.addIngredientInfo(new ItemStack(item), VanillaTypes.ITEM_STACK, Component.translatable(GeneratorGalore.MODID + ".ingredient.description." + itemName));
//        }
    }
